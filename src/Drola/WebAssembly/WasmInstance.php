...
class WasmInstance
{
     ...
     * @param object $importObject An object containing the values to be imported
     *  into the newly-created Instance, such as functions or WebAssembly.Memory
     *  objects. There must be one matching property for each declared import of
     *  module or else a WebAssembly.LinkError is thrown.
     */
     ...
     * the WebAssembly module instance, to allow them to be accessed and used by PHP.
     */
